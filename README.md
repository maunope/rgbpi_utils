...
- provide three folders for Box Art, Title Screen and Snaps, Libretro Thumbnails repo comes in this form. **important** process one system at a time, don't mix images from different systems.
